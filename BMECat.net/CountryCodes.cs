...
namespace BMECat.net
{
    ...
    public static class CountryCodesExtensions
    {
        ...
        /// </summary>
        private static Dictionary<string, CountryCodes> _Mapping = null;
        ...
        {
            _Mapping = new Dictionary<string, CountryCodes>();
            foreach (CountryCodes code in Enum.GetValues(typeof(CountryCodes)))
            {
